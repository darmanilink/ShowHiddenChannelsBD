 ...
 */
//BD can shove its TOS up its ass. The whole thing that made it great was how it let you do what you want with your own client rather than restrict it.
//maybe if discord could properly handle their own fucking shit server side rather than use our CPUs to do their work for them they wouldn't have this problem
module.exports = (_ => {
	const changeLog = {
	};
		...
		return class ShowHiddenChannels extends Plugin {
			...
			setLabelsByLanguage () {
				switch (BDFDB.LanguageUtils.getLanguage().id) {
					...
					case "zh-CN":	// Chinese (West Taiwan)
						return {
